...
This guide explains the settings you need to use to configure SAML with your Identity Provider. Once this is set up you should get an XML metadata file that should then be uploaded on your Timely self-hosted instance.
...
**Entity ID / Identifier / Audience URI / Audience Restriction:** https://saml.timely
