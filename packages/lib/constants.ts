...
export const WEBSITE_URL = process.env.NEXT_PUBLIC_WEBSITE_URL || "https://timely";
export const APP_NAME = process.env.NEXT_PUBLIC_APP_NAME || "Timely";
export const SUPPORT_MAIL_ADDRESS = process.env.NEXT_PUBLIC_SUPPORT_MAIL_ADDRESS || "help@timely";
export const COMPANY_NAME = process.env.NEXT_PUBLIC_COMPANY_NAME || "Timely, Inc.";
export const SENDER_ID = process.env.NEXT_PUBLIC_SENDER_ID || "Cal";
export const SENDER_NAME = process.env.NEXT_PUBLIC_SENDGRID_SENDER_NAME || "Timely";

// This is the URL from which all Cal Links and their assets are served.
// Use website URL to make links shorter(timely and not app.timely)
...
export const IS_CALCOM =
  WEBAPP_URL &&
  (new URL(WEBAPP_URL).hostname.endsWith("timely") ||
...
export const LOGO = "/timely-logo-white-word.svg";
...
export const ROADMAP = "https://timely/roadmap";
export const DESKTOP_APP_LINK = "https://timely/download";
export const JOIN_DISCORD = "https://go.timely/discord";
export const POWERED_BY_URL = `${WEBSITE_URL}/?utm_source=embed&utm_medium=powered-by-button`;
export const DOCS_URL = "https://timely/docs";
export const DEVELOPER_DOCS = "https://developer.timely";
