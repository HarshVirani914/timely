...
<div align="center">
  ...
  <a href="https://console.timely/">Get a License Key</a>
</div>
...
The [/ee](https://github.com/timely/timely/tree/main/packages/features/ee) subfolder is the place for all the **Enterprise Edition** features from our [hosted](https://timely/pricing) plan and enterprise-grade features for [Ultimate](https://timely/ultimate) such as SSO, SAML, OIDC, SCIM, SIEM and much more or [Platform](https://timely/platform) plan to build a marketplace.

> _❗ WARNING: This repository is copyrighted (unlike our [main repo](https://github.com/timely/timely)). You are not allowed to use this code to host your own version of app.timely without obtaining a proper [license](https://console.timely/) first❗_
