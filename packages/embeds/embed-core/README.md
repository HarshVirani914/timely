...
See <https://developer.timely/embed/install-with-javascript>

You can also see various example usages [here](https://github.com/timely/timely/blob/main/packages/embeds/embed-core/index.html)
...
Make `dist/embed.umd.js` servable on URL <http://timely/embed.js>
...
- Branding
  ...
  - Powered by Timely and 'Try it for free'. Should they be shown only for FREE account.
